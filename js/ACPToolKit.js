var ACPToolKit = (function () {
    ...
    if ((window.location.pathname.indexOf('experiment') > -1 ) || (window.location.pathname.indexOf('experiment') > -1 ) ) {
        ...
        module.presentTrial = function (options) {
            ...
            $('.js-expt-activity').text(options.activity);
            ...
            var iface = new AutoComPaste.Interface(wm, engine, data_file, activity, stimuli.split("\n\n"));
